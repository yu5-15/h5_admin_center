    ...
    <div class="contentBox">
      <div class="contentLeftBox">
        <div class="contentTBox">
          <span class="contentT1">彼岸项目云</span>
      ...
      <div class="contentRightBox">
        <div class="loginBox">
            ...
            <div class="loginInputBox">
              ...
              <el-input v-model="user_password" class="loginImput" show-password  maxlength="6" placeholder="请输入内容"></el-input>
  ...
  export default {
    ...
    methods: {
      tt: function () {
        ...
        //定义业务参数
        var reqDataJson = {'mobile': this.user_mobile, "verify_code": this.user_password};
        //定义接口地址
        var apiPath = "sys/user/admin_loadByName.json"
        //加密，返回完整请求地址
